...
public class RejectPendingPermissionRequestServlet extends HttpServlet {
    ...
    protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            engineManager.rejectSelectedPermissionRequest(sheetName, username,
                                                          permissionLevelRequested.toUpperCase(),
                                                          numOfRequestForSheet);
